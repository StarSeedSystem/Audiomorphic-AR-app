...
const ControlPanel: React.FC<ControlPanelProps> = ({ 
  ...
  // ── APP LIBRE Y COMPLETA (2026-07-13) ──────────────────────────────────────
  // Ya no hay planes: todo abierto para todo el mundo, con o sin cuenta.
  // (Antes `isLocked = !isPremium` cerraba DE VERDAD la Deriva, los modos de
  // aleatorizacion, la deteccion de emocion/ritmo, la autorregeneracion
  // avanzada, la geometria sagrada, los temas, el VR/AR y los presets.)
  ...
  const handleMovePriority = (index: number, direction: 'up' | 'down') => {
    ...
    if (target < 0 || target >= cloudPresets.length) return;
